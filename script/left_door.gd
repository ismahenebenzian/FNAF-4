...
@onready var door_sprite = $MainInterface/Zoom_Porte_gauche/DoorSplit
...
func _ready():
	...
	if door_sprite == null:
		print("ERREUR : door_sprite est null. Vérifie le chemin.")
		return
	...
	print("🚪 Porte gauche ouverte au départ")
